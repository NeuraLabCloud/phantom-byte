...
// ported from - https://codepen.io/carolineartz/pen/qBOEzQa
const NeonCatAnimation: FC<NeonCatProps> = () => {
	useEffect(() => {
		const ID = 'bongo-cat';
					...
					<g id='bongo-cat'>
						<g className='head'>
							...
							<g className='headphone headphone-right'>
								...
								<path
									className='band'
									d='M515,40.6c-15.9-4.6-57-14.1-104,2.3a166.9,166.9,0,0,0-60.9,37.3'></path>
							</g>
						</g>
						...
						<polygon
							...
							points='103.2 263.6 258.9 219.3 636.5 294.4 452.1 339 103.2 263.6'></polygon>
						...
						<g className='paw paw-right'>
							<path
								className='down'
								d='M289.1,181.7c-12.1,9.8-20.6,20.7-20.7,32.1-.2,9,3.8,20.4,13.3,25.2s20.1.6,29.6-3.4c13.4-5.7,23.9-14.6,29.4-21.5'></path>
							<g className='up'>
						...
						<polygon
							...
							points='93.8 63.3 284.1 73 335.9 230.5 146.2 197.6 93.8 63.3'></polygon>
						...
						<polygon
							...
							points='103.2 263.6 452.1 339 360.8 12.4 2 2 103.2 263.6'></polygon>
						<g className='paw paw-left'>
							...
							<path
								className='down'
								d='M534.1,231.4c-19.7,6-32.9,18.4-34.2,29.1a30.1,30.1,0,0,0,1.7,14.1,24.8,24.8,0,0,0,6.1,8.8c6,5.1,16.8,4,38-3.9a288.7,288.7,0,0,0,46.5-22.1'></path>
						</g>
						<g className='headphone headphone-left'>
							...
							<path
								className='band'
								d='M638.9,157.7c-4-16.8-25.9-61.9-75.3-95.3A155.5,155.5,0,0,0,515,40.6'></path>
						</g>
...
export default NeonCatAnimation;
